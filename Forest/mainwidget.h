...
public slots: //публичные слоты
    ...
    void Remove_plant_and_resort(int num_sort, struct plant_sort **plants, int *kolvo_plants); //удалить растение (оно зачахло) и убрать запись о нём в структуре сортировки
